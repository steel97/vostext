...
## Полноэкранный режим
- после автоматического переключения серии нужно взаимодействие с вкладкой (достаточно клика в любом месте страницы с плеером) для перехода в полноэкранный режим